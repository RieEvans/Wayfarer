...
export const TrendingDest = () => {
  return (
    <div className={`mx-auto `}>
      ...
      <section className="relative shadow-xl mt-5 grid content-center justify-content-center xl:grid-cols-3 xxl:grid-cols-4 mmd:grid-flow-row-dense gap-3 [&>*:nth-child(odd)]:col-span-2 [&>*:nth-child(5)]:col-span-1 cursor-pointer overflow-hidden ">
